<!-- // Renders a sidebar based on user role: Admins see user management options, 
// and students see their course-related options. -->
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="pages" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <?php 
                            ...
                            <li class="sidebar-item">
                                <a href="/studentdashboard" class="sidebar-link">
                                <?php echo htmlspecialchars($row['CourseName'], ENT_QUOTES, 'UTF-8'); ?>
                                </a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
