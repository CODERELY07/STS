<!-- admindashboard to view students with crud -->
<?php 
                                            ...
                                            <table class="table table-fixed">
                                                ...
                                                <tbody>
                                                    <?php foreach ($rows as $row): ?>
                                                        <tr>
                                                            <td scope="row"><?= htmlspecialchars($row['firstname'] . ' ' . $row['middlename'] . ' ' . $row['lastname'], ENT_QUOTES, 'UTF-8') ?></td>
                            ...
                            <div class="card-body p-0 d-flex flex-fill">
                                <div class="row g-0 w-100">
                                    <div class="col-12 p-2">
                                        <div class="m-1">
                                            <h4>Taked Exams</h4>
                                            <p class="mb-0">All students that take the exams</p>
                                        </div>
                                        <div class="table-responsive">
                                            <table class="table table-fixed">
                                                <thead>
                ...
                <div class="card border-0">
                    <div class="card-header">
                        ...
                        <h6 class="card-subtitle text-muted">
                            All the students that are enrolled
                        </h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-fixed">
