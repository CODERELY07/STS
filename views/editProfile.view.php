<!-- this code edit students profile and account -->
<?php
                    ...
                    <form action="/editStudPersonalInfo" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="gender" id="gender">
                                <option value=""></option>
                                <option value="male" <?= (htmlspecialchars($student['gender'], ENT_QUOTES, 'UTF-8') == 'male' ? 'selected' : '') ?>>Male</option>
                                <option value="female" <?= (htmlspecialchars($student['gender'], ENT_QUOTES, 'UTF-8') == 'female' ? 'selected' : '') ?>>Female</option>
                                <option value="other" <?= (htmlspecialchars($student['gender'], ENT_QUOTES, 'UTF-8') == 'other' ? 'selected' : '') ?>>Other</option>
                            </select>
                        </div>
